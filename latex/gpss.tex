...
In addition to producing highly interpretable decompositions of regression functions, our method also produces state of the art predictions in both extrapolation and interpolation tasks. \TBD{RBG: Since the previous section is also part of empirical evaluation, maybe a better title for this section would be ``quantitative comparisons?''}
