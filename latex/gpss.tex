...
True kernel & $d$ & Inferred kernel & SNR of model fit & Temp col & Temp col \\
\hline
...
Despite this, our approach fails gracefully: the learned kernel still captures the overall periodic structure
% and longer term trends
, and the extrapolation is honest about its uncertainty.\fTBD{Add changepoint citation or do not include to prevent blocking other work}
