...
\TBD{Needs works e.g.~justification / cite Roger}
...
\item Set $\aleph$ = expansion of all kernels in $\beth$.
\end{enumerate}
...
\begin{figure}
\centering
\newcommand{\fwmaunag}{8cm}
\newcommand{\hmg}{3cm}
\begin{tabular}{c}
 \includegraphics[width=\fwmaunag,height=\hmg]{../figures/decomposition/03-mauna2003_max_level_0/03-mauna2003_all} \\ 
 \includegraphics[width=\fwmaunag,height=\hmg]{../figures/decomposition/03-mauna2003_max_level_1/03-mauna2003_all} \\
 \includegraphics[width=\fwmaunag,height=\hmg]{../figures/decomposition/03-mauna2003_max_level_2/03-mauna2003_all}
\end{tabular}
\caption{Posterior mean and variance for different levels of kernel search.  In the first row, the function is only modeled as a locally smooth function, and the extrapolation is extemely poor.  In the second, a periodic component is added, and the extrapolation is better.  At depth 3, the kernel can capture most of the relevant structure, and is able to extrapolate reasonably.}
...
\newcommand{\hmg}{3cm}  % height maunu growth
\begin{tabular}{c}
...
\newcommand{\hag}{3cm}  % height airline growth
\begin{tabular}{c}
