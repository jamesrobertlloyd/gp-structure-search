...
In order to investigate our method's ability to discover structure, we ran the kernel search on several time-series.
...
\footnotetext{
%\NA{
In one dimension, the predictive means of all baseline methods in table \ref{tbl:Regression Mean Squared Error} are identical to a \gp{} with an $\kSE{}$ kernel.}
%}
