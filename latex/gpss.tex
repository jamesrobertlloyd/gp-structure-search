...
A number of standard model forms can be expressed as composite kernels.
...
Generalized Additive Models & $SE_1$ + $SE_2$ + \dots + $SE_D$\\
GP-ARD & $SE_1$ $\times$ $SE_2$ $\times$ \dots $\times$ $SE_D$ \\
Long-term trends: & Lin + SE or Lin $\times$ SE
\end{tabular}
