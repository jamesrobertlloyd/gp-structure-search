...
Cite Tao Hong.
Reference that this is similar to Mauna Loa but we also have a temperature variable selection problem.
Mention recent Kaggle competition.
Discuss zones 1 and 9 as contrasting problems.

Additive interpretation does not work for plotting since we might be additive in the same dimension \frownie.
\TBD{Any thoughts on how to get around this?}
