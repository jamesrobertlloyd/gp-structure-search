...
\caption{A part of the decomposition of the posterior on the Mauna dataset.}
\end{figure}
...
\subsection{Deriving the marginal variance}
...
\end{align*}
then by the formula for Gaussian conditionals, we get that
\begin{align*}
