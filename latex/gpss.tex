...
\begin{figure}[h!]
\newcommand{\wmgd}{9.5cm}  % width mauna growth decomp
\newcommand{\hmgd}{3.1cm}  % height mauna growth decomp
...
\begin{figure}[h!]
\centering
\newcommand{\wagd}{9.5cm}  % width airline growth decomp
\newcommand{\hagd}{3.19cm}  % height airline growth decomp
\newcommand{\ard}{../figures/decomposition/11-Feb-01-airline-s}  % airline results dir
\begin{tabular}{c}
\hspace{-1cm}\includegraphics[width=\wagd,height=\hagd]{\ard/01-airline-s_all} \\
% = \\ 
\hspace{-1cm} \includegraphics[width=\wagd,height=\hagd]{\ard/01-airline-s_4} \\
% + \\
\hspace{-1cm} \includegraphics[width=\wagd,height=\hagd]{\ard/01-airline-s_3} \\
% + \\
\hspace{-1cm}  \includegraphics[width=\wagd,height=\hagd]{\ard/01-airline-s_2} \\
% + \\
\hspace{-1cm}   \includegraphics[width=\wagd,height=\hagd]{\ard/01-airline-s_1} \\
% + \\
\hspace{-1cm} \includegraphics[width=\wagd,height=\hagd]{\ard/01-airline-s_resid}
\end{tabular}
