...
When used within the context of GP regression, these kernels define priors on functions which are smooth, smooth and periodic or linear respectively.
...
Multiplication of kernels does not correspond to a simple decomposition of functions, but allows for the construction of more complex structures.
