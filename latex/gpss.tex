...
Figure \ref{fig:mauna_all} shows the complete posterior of a $\gp$ regression model of the Mauna Loa dataset.  Figure \ref{fig:mauna_decomp} shows the same posterior signal decomposed into long-term, periodic, medium-term and short-term components, respectively.
