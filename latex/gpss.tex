...
For each fold of each data set we trained each method on the other 9 folds, and then computed predictive mean squared error (MSE) and mean negative predictive log likelihood of the held out fold.
Average statistics for these experiments are presented in tables \ref{table:MSE} and \ref{table:nll}.

=======
>>>>>>> f17af2f4cf91af9009ac36e29c71e877e65011f5
\begin{table*}[h!]
\begin{center}
