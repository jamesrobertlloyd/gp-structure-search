...
Despite this, our approach fails gracefully: the learned kernel still captures the periodic structure, and the model reports high uncertainty about the long-term structure.
%
...
%
Structure search was run up to depth 10, using the \kSE{} and \kRQ{} kernels.
