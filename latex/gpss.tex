...
A number of standard and/or interesting model forms can be expressed as composite kernels, including
\begin{itemize}
\item \eg Lin, Lin $\times$ Lin, \ldots is Bayesian polynomial regression.
\item linear
\item generalized fourier decomposition is per + per
\item quadratric lin * lin
\item GAM se1 + se2
\item ARD se1 * se2
\item detrending: lin + se or lin*se
\end{itemize}
