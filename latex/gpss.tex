...
None of the models in our search space are capable of representing this structure, since all of the base kernels apart from \kLin{} are stationary, and it is hard to see how \kLin{} would help in modeling this structure.
