...
%The x-axis has the same scale for all plots.
  Left column and third column: base kernels $k(\cdot,0)$.  Second and fourth columns: draws from a \gp{} with each repective kernel.  The x-axis has the same range on all plots.}
