...
\begin{tikzpicture}[x=0.5\textwidth]
    ...
    % MIT badge
    \node [mybox] (MIT Badge) at (-0.9, 0) {
        \Huge{MIT!}
    };
    % QR code
    \node [mybox] (QR code) at (-0.8, 0) {
        \Huge{QR}
    };
\end{tikzpicture}
\end{center}
...
\mysection{Structured data sets}
...
\mysection{Corresponding GP kernel structures}

\vspace{4\baselineskip}

\begin{center}
  \huge{Figures 1 and 2}
\end{center}
...
\mysection{A grammar for statistical models}

\vspace{4\baselineskip}

\begin{center}
  \huge{Remember the example expressions table}
\end{center}

\vspace{4\baselineskip}

\mysection{Learning grammar stagewise}
