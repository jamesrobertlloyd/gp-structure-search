...
\mysection{Data may often exhibit high level structure \eg linearity, periodicity\ldots}

\vspace{4\baselineskip}

\begin{center}
  \huge{Display some 1d data sets - linear, quadratic, periodic, airline}
\end{center}

\vspace{4\baselineskip}

\begin{itemize}
  \item Seemingly different regression methods would be required to model these data sets, and produce credible extrapolations
  \item \ldots
  \item \ldots
\end{itemize}
...
\begin{itemize}
  ...
  \item We consider all algebraic expressions involving a small number of base kernels and the operations `$+$' and `$\times$'
...
\begin{center}
  \huge{Draw a picture of the search}
\end{center}
