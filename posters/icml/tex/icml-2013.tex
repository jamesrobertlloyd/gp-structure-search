...
\begin{itemize}
  ...
  \item Therefore, we can visualise the learned kernels be decomposing the posterior into a sum of interpretable component functions% (additive components of the kernel correspond to independent additive functions)
\end{itemize}
