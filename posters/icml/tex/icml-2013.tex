...
\vspace{1\baselineskip}
\mysection{\ldots defining an open-ended set of models}
...
\begin{tabular}{cc}
\begin{tabular}{c}
\includegraphics[width=0.2\textwidth]{../figures/radio/monthly-critical-radio-frequenci_all.pdf}
\end{tabular} &
\begin{tabular}{cc}
\includegraphics[width=\postdw]{../figures/radio/monthly-critical-radio-frequenci_3.pdf} &
\includegraphics[width=\postdw]{../figures/radio/monthly-critical-radio-frequenci_4.pdf} \\
Long-term smooth + \quad &
Yearly priodic \\
\includegraphics[width=\postdw]{../figures/radio/monthly-critical-radio-frequenci_2.pdf} &
\includegraphics[width=\postdw]{../figures/radio/monthly-critical-radio-frequenci_5.pdf} \\
