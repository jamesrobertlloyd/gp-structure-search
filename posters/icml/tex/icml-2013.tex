...
\begin{itemize}
  \item We consider all algebraic expressions composed of a small number of base kernels and the operations `$+$' and `$\times$'
...
\vspace{0.5\baselineskip}
\paragraph{\large Special cases in this set}
\begin{center}
  \begin{tabular}{lc|cl}
  \\
...
\vspace{1\baselineskip}
    ...
    \hfill    \includegraphics[height=6cm]{../badges/QR.png}
 
 Code available at \url{http://www.github.com/jamesrobertlloyd/gp-structure-search}
