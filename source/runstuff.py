...
def call_cluster(k=3, max_depth=2):
    ...
    fear_string = '''. /usr/local/grid/divf2/common/settings.sh; qsub -l lr=0 /home/mlg/dkd23/git/gp-structure-search/source/run_python.sh /home/mlg/dkd23/git/gp-structure-search/%(dataset)s /home/mlg/dkd23/git/gp-structure-search/%(results_filename)s %(depth)s %(k)s'''
